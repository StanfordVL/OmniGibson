...
class Task(Model):
    ...
    def view_challenge(cls):
        ...
        CHALLENGE_TASKS = [
            ...
            "preserving_meat-0",
            "bringing_glass_to_recycling-0watering_outdoor_flowers-0",
            "fill_a_bucket_in_a_small_sink-0",
            "can_syrup-0",
            "can_beans-0",
            "carrying_water-0",
            "filling_salt-0",
            "mixing_drinks-0adding_chemicals_to_pool-0",
            "spraying_for_bugs-0",
            "painting_porch-0",
            ...
            "installing_alarms-0",
            "turning_out_all_lights_before_sleep-0chop_an_onion-0",
            ...
            "make_cookies-0",
            "make_dinner_rolls-0clean_a_hamper-0",
            "clean_a_tie-0",
