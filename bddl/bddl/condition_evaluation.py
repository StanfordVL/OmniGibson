...
class Implication(Expression):
    def __init__(self, scope, backend, body, object_map):
        ...
        self.children.append(get_predicate_for_token(antecedent[0], backend)(
            scope, antecedent[1:], object_map))
        self.children.append(get_predicate_for_token(consequent[0], backend)(
            scope, consequent[1:], object_map))
...
def compile_state(parsed_state, backend, scope=None, object_map=None):
    ...
    for parsed_condition in parsed_state:
        ...
        compiled_state.append(
            HEAD(scope, backend, parsed_condition, object_map))
