    ...
    (:goal 
        (and 
            (and 
                ...
                (nextto ?folder.n.02_1 ?bag.n.01_1) 
                (nextto ?book.n.02_1 ?bag.n.01_1)
            ) 
            (inside ?highlighter.n.02_1 ?bag.n.01_1) 
            (inside ?pencil.n.01_1 ?bag.n.01_1) 
            (inside ?pen.n.01_1 ?bag.n.01_1) 
            (inside ?calculator.n.02_1 ?bag.n.01_1) 
