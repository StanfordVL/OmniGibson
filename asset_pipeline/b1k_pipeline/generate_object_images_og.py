...
def main():
    with PipelineFS() as pipeline_fs, \
        ...
        gm.DATASET_PATH = dataset_fs.getsyspath("/")
        ...
        for obj_category, obj_model in tqdm.tqdm(all_models):
            ...
            # 3-second webp
            with out_fs.open(f"{obj_category}-{obj_model}.webp", "wb") as f:
                images[0].save(f, format="webp", save_all=True, append_images=images[1:], duration=3000 // timesteps, loop=0)
