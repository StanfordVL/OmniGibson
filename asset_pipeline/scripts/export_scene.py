...
from .mesh_tree import build_mesh_tree
from .export_objs import compute_bounding_box
...
def main():
    ...
    output_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "cad", target, "artifacts/scene")
