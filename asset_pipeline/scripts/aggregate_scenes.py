...
OUTPUT_FILENAME = os.path.join(os.path.dirname(os.path.dirname(__file__)), "artifacts/pipeline/aggregate_scenes.json")
SUCCESS_FILENAME = os.path.join(os.path.dirname(os.path.dirname(__file__)), "artifacts/pipeline/aggregate_scenes.success")
...
def main():
    ...
    try:
        ...
        for target in targets:
            ...
            source_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "cad", target, "artifacts/scene")
            destination_dir = os.path.join(SCENE_ROOT_DIR, scene_name)
