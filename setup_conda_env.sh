...
CONDA_ACT_FILE="${CONDA_PREFIX}/etc/conda/activate.d"
...
CONDA_DEACT_FILE="${CONDA_PREFIX}/etc/conda/deactivate.d"
...
# Now activate the omnigibson environment and install omnigibson!
