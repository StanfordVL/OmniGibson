...
env = ActionPrimitiveWrapper(env=env, action_generator="BehaviorActionPrimitives", num_attempts=1)
sim = env.simulator
...
cam.set_position_orientation(np.array([-2.501, -3.318, 1.791]), np.array([ 0.3946225, -0.370471, -0.575514, 0.6130318 ]))
sim.step()
sim.step()
sim.step()
