...
class Tiago(ManipulationRobot, LocomotionRobot, ActiveCameraRobot):
    ...
    def temp_disabled_collision_pairs(self):
        ...
        #     ['head_1_link', 'head_2_link'],
        #     ['torso_fixed_column_link', 'arm_right_1_link'],
        #     # added for simplified mesh
        #     ['torso_lift_link', 'arm_right_3_link'],
        #     ['torso_lift_link', 'arm_left_3_link'],
        #     ['torso_lift_link', 'head_2_link'],
        #     ['gripper_left_link', 'arm_left_4_link'], 
        #     ['arm_left_6_link', 'arm_left_4_link'], 
        #     ['gripper_left_right_finger_link', 'gripper_left_link'], 
        #     ['gripper_left_link', 'gripper_left_left_finger_link'], 
        #     ['arm_right_4_link', 'gripper_right_link'], 
        #     ['arm_right_6_link', 'arm_right_4_link'], 
        #     ['gripper_right_left_finger_link', 'gripper_right_link'], 
        #     ['gripper_right_right_finger_link', 'gripper_right_link']
        #     ['arm_left_4_link', 'torso_fixed_column_link'], ['arm_left_2_link', 'torso_fixed_column_link'], ['arm_right_4_link', 'torso_fixed_column_link'], ['arm_right_2_link', 'torso_fixed_column_link'], ['gripper_left_right_finger_link', 'torso_lift_link'], ['gripper_left_left_finger_link', 'torso_lift_link'], ['gripper_left_link', 'torso_lift_link'], ['arm_left_6_link', 'torso_lift_link'], ['arm_left_4_link_mesh_1', 'torso_lift_link'], ['arm_left_4_link_mesh_0', 'torso_lift_link'], ['arm_right_4_link_mesh_1', 'torso_lift_link'], ['arm_right_4_link_mesh_0', 'torso_lift_link'], ['gripper_right_left_finger_link', 'torso_lift_link'], ['gripper_right_right_finger_link', 'torso_lift_link'], ['gripper_right_link', 'torso_lift_link'], ['arm_right_6_link', 'torso_lift_link']
        # ]
