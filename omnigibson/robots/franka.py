    ...
    def __init__(
        ...
        **kwargs,
        ...
        if end_effector == "gripper":
            ...
            self._default_robot_model_joint_pos = th.cat(([0.86, -0.27, -0.68, -1.52, -0.18, 1.29, 1.72], np.zeros(16)))
            ...
            # position where the hand is parallel to the ground
            self._default_robot_model_joint_pos = th.cat(([0.86, -0.27, -0.68, -1.52, -0.18, 1.29, 1.72], np.zeros(12)))
