...
class AntiAliasingSettings(SubSettingsBase):
    def __init__(self):
        ...
        self.algorithm = SettingItem(self, lo.omni.kit.widget.settings.SettingType.STRING, "Algorithm", "/rtx/post/aa/op", antialiasing_ops)

        # antialiasing_op_idx == 1
        # TAA
        self.static_ratio = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.FLOAT, "Static scaling", "/rtx/post/scaling/staticRatio", range_from=0.33, range_to=1
        )
        self.samples = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.INT, "TAA Samples", "/rtx/post/taa/samples", range_from=1, range_to=16
        )
        self.alpha = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.FLOAT, "TAA history scale", "/rtx/post/taa/alpha", range_from=0, range_to=1
        )

        # antialiasing_op_idx == 2
        # FXAA
        self.quality_sub_pix = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.FLOAT, "Subpixel Quality", "/rtx/post/fxaa/qualitySubPix", range_from=0.0, range_to=1.0
        )
        ...
        self.exec_mode = SettingItem(self, lo.omni.kit.widget.settings.SettingType.STRING, "Execution mode", "/rtx/post/dlss/execMode", dlss_opts)

        self.sharpness = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.FLOAT, "Sharpness", "/rtx/post/aa/sharpness", range_from=0.0, range_to=1.0
        )

        exposure_ops = ["Force self evaluated", "PostProcess Autoexposure", "Fixed"]
        self.auto_exposure_mode = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.STRING, "Exposure mode", "/rtx/post/aa/autoExposureMode", exposure_ops
        )
        ...
        self.exposure = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.FLOAT, "Fixed Exposure Value", "/rtx/post/aa/exposure", range_from=0.00001, range_to=1.0
        )
...
class DirectLightingSettings(SubSettingsBase):
    def __init__(self):
        ...
        self.shadows_enabled = SettingItem(self, lo.omni.kit.widget.settings.SettingType.BOOL, "Enable Shadows", "/rtx/shadows/enabled")

        self.sampled_lighting_enabled = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "Enable Sampled Direct Lighting", "/rtx/directLighting/sampledLighting/enabled"
        )
        ...
        self.shadows_sample_count = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.INT, "Shadow Samples per Pixel", "/rtx/shadows/sampleCount", range_from=1, range_to=16
        )
        self.shadows_denoiser_quarter_res = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "Lower Resolution Shadows Denoiser", "/rtx/shadows/denoiser/quarterRes"
        )
        self.dome_light_enabled = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "Dome Lighting", "/rtx/directLighting/domeLight/enabled"
        )
        ...
        self.dome_light_enabled_in_reflections = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "Dome Lighting in Reflections", "/rtx/directLighting/domeLight/enabledInReflections"
        )
        ...
        self.history_clamping_enabled = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "History Clamping", "/rtx/lightspeed/ReLAX/historyClampingEnabled"
        )
...
class ReflectionsSettings(SettingsBase):
    def __init__(self):
        ...
        self.max_roughness = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.FLOAT, "Max Roughness", "/rtx/reflections/maxRoughness", range_from=0.0, range_to=1.0
        )
...
class TranslucencySettings(SettingsBase):
    def __init__(self):
        ...
        self.fractional_cutou_opacity = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "Enable Fractional Cutout Opacity", "/rtx/raytracing/fractionalCutoutOpacity"
        )
        self.virtual_depth = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "Enable Depth Correction for DoF", "/rtx/translucency/virtualDepth"
        )
...
class GlobalVolumetricEffectsSettings(SubSettingsBase):
    def __init__(self):
        ...
        self.pixel_ratio = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.INT, "Pixel Density", "/rtx/raytracing/inscattering/pixelRatio", range_from=4, range_to=64
        )
        ...
        self.transmittance_color = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.COLOR3, "Transmittance Color", "/rtx/raytracing/inscattering/transmittanceColor"
        )
        ...
        self.single_scattering_albedo = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.COLOR3, "Single Scattering Albedo", "/rtx/raytracing/inscattering/singleScatteringAlbedo",
        )
        ...
        self.use_detail_noise = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "Apply Density Noise", "/rtx/raytracing/inscattering/useDetailNoise"
        )
        ...
        self.use_32bit_precision = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "Use 32-bit Precision", "/rtx/raytracing/inscattering/use32bitPrecision"
        )
...
class CausticsSettings(SettingsBase):
    def __init__(self):
        ...
        self.positio_phi = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.FLOAT, "Position Phi", "/rtx/raytracing/caustics/positionPhi", range_from=0.1, range_to=50
        )
        self.normal_phi = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.FLOAT, "Normal Phi", "/rtx/raytracing/caustics/normalPhi", range_from=0.3, range_to=1
        )
...
class IndirectDiffuseLightingSettings(SettingsBase):
    def __init__(self):
        ...
        self.ambient_light_color = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.COLOR3, "Ambient Light Color", "/rtx/sceneDb/ambientLightColor"
        )
        ...
        self.ambient_occlusion_enabled = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "Enable Ambient Occlusion (AO)", "/rtx/ambientOcclusion/enabled"
        )
        ...
        self.aggressive_denoising = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "AO: Aggressive denoising", "/rtx/ambientOcclusion/aggressiveDenoising"
        )

        self.indirect_diffuse_enabled = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "Enable Indirect Diffuse GI", "/rtx/indirectDiffuse/enabled"
        )
        ...
        self.max_bounces = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.INT, "Max Bounces", "/rtx/indirectDiffuse/maxBounces", range_from=0, range_to=16
        )
        self.scaling_factor = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.FLOAT, "Intensity", "/rtx/indirectDiffuse/scalingFactor", range_from=0.0, range_to=20.0
        )
...
class RTMultiGPUSettings(SubSettingsBase):
    def __init__(self):
        ...
        self.tile_count = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.INT, "Tile Count", "/rtx/realtime/mgpu/tileCount", range_from=2, range_to=currentGpuCount
        )
        self.master_post_processOnly = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.BOOL, "GPU 0 Post Process Only", "/rtx/realtime/mgpu/masterPostProcessOnly"
        )
        self.tile_overlap = SettingItem(
            self, lo.omni.kit.widget.settings.SettingType.INT, "Tile Overlap (Pixels)", "/rtx/realtime/mgpu/tileOverlap", range_from=0, range_to=256
        )
