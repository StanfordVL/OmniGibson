...
class StarterSemanticActionPrimitives(BaseActionPrimitiveSet):
    ...
    def _move_hand_joint(self, joint_pos, control_idx):
        ...
        if self.teleport:
            ...
            # plan = [[0.09997262060642242, -1.0293538570404053, 1.4700201749801636, 2.709970235824585, 1.749015212059021, -1.5699917078018188, 1.3900072574615479, -4.500867362366989e-06], [0.17310083472788063, -0.16395415443791306, 0.6493423954272051, 0.35596773475041354, 1.6620833251975728, -0.5610505236745118, 0.4627156745168741, -0.8245780205427806], [0.2639267406915869, 0.5287484460980867, 0.9310798026499372, 1.1880665334519338, 1.4070242049676136, -0.5950751646876724, -0.6329959528310227, -0.3663297042381404], [0.3499999940395355, 0.797061153035568, 0.563012947438238, 1.6064849888977755, 1.3332271524676396, -0.5441944199948349, -1.4137165546417236, -0.6586847701345278]]
            # plan = self._add_linearly_interpolated_waypoints(plan, 0.1)
