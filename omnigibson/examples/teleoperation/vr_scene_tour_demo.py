...
def main():
    ...
    vrsys.vr_profile.set_physical_world_to_world_anchor_transform_to_match_xr_device(vrsys.og2xr(th.tensor([0.1, 0.2, 1.0]), th.tensor([0.0, 0.0, 0.0, 1.0])).numpy(), vrsys.hmd)
