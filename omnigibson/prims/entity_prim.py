...
class EntityPrim(XFormPrim):
    ...
    def set_position_orientation(self, position=None, orientation=None):
        ...
        # If the simulation isn't running, we should set this prim's XForm properties directly
    ...
    def get_position_orientation(self):
        # If the simulation isn't running, we should read from this prim's XForm properties directly
        if og.sim.is_stopped():
