...
class ClothPrim(GeomPrim):
    ...
    def _post_load(self):
        ...
        self._mass_api = lo.UsdPhysics.MassAPI(self._prim) if self._prim.HasAPI(lo.UsdPhysics.MassAPI) else \
    ...
    def _initialize(self):
        ...
        self._prim.CreateAttribute("primvars:isVolume", lo.ValueTypeNames.Bool, False).Set(True)
    ...
    def set_particle_positions(self, positions, idxs=None):
        ...
        self.set_attribute(attr="points", val=lo.Vt.Vec3fArray.FromNumpy(p_local))
    ...
    def reset(self):
        ...
        """
        if self.initialized:
            self.set_attribute(attr="points", val=lo.Vt.Vec3fArray.FromNumpy(self._default_positions))
