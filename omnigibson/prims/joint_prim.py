...
class JointPrim(BasePrim):
    ...
    def _post_load(self):
        ...
        self._driven = self._prim.HasAPI(lo.UsdPhysics.DriveAPI)
        ...
        if self.is_single_dof:
            ...
            assert self._prim.HasAPI(lo.PhysxSchema.JointStateAPI), \
    ...
    def body0(self, body0):
        ...
        self._prim.GetRelationship("physics:body0").SetTargets([lo.Sdf.Path(body0)])
    ...
    def body1(self, body1):
        ...
        self._prim.GetRelationship("physics:body1").SetTargets([lo.Sdf.Path(body1)])
    ...
    def local_orientation(self):
        ...
        quat0 = lo.gf_quat_to_np_array(self.get_attribute("physics:localRot0"))[[1, 2, 3, 0]]
        quat1 = lo.gf_quat_to_np_array(self.get_attribute("physics:localRot1"))[[1, 2, 3, 0]]
