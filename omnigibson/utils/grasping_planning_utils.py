...
def get_grasp_poses_for_object_sticky(target_obj, direction="down"):
    """
    ...
    grasp_center_pos = bbox_center_world + grasp_offset
    ...
    grasp_quat = T.euler2quat(th.tensor(grasp_euler, dtype=th.float32))
