...
<table markdown="span">
    ...
    <tr>
        <td valign="top" width="60%">
            [**`ObjectsInFOVOfRobot`**](../reference/object_states/robot_related_states.html)<br><br> 
    ...
    <tr>
        <td valign="top" width="60%">
            [**`Open`**](../reference/object_states/open_state.html)<br><br>  
            ...
            <ul>
                <li>`get_value()`: returns `True / False`</li>
                <li>`set_value(new_value, fully=False)`: expects `True / False`, randomly sampling a valid open / not open configuration unless `fully` is set</li>
            </ul>
        </td>
        <td>
        </td>
    ...
    <tr>
        <td valign="top" width="60%">
            [**`ToggledOn`**](../reference/object_states/temperature.html)<br><br>  
